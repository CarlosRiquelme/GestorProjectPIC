...
class TestGrupo(TestCase):
	def setUp(self):
		print "\n TEST Grupo Existe"
		print "\nBuscar Grupo Creado"
		#Grupo.objects.create(nombre='Grupo')
		dato={'nombre':'nombre1', 'descripcion':'lala', 'fechaCreacion':'2015-04-09'}
	def test_traet(self):
		valido=True
		#valido=Grupo.objects.filter(nombre='Grupo').exists()
		if valido==False:
			print "\nNo existe el Grupo"
		if valido == True:
			print "\nExiste el Grupo"
...
class TestGrupoNO(TestCase):

	def setUp(self):
		print "\n TEST Grupo no Existe"
		print "\nBuscar Grupo Creado"
		#Grupo.objects.create(nombre='Grupo')
		dato={'nombre':'nombre1', 'descripcion':'lala', 'fechaCreacion':'2015-04-09'}
	def test_traet(self):
